...
# Función para encontrar el nombre de ataque más similar en una lista
def find_most_similar_attack_name(target_name, attack_names):
    similar_names = difflib.get_close_matches(target_name, attack_names, n=1, cutoff=0.8)
    return similar_names[0] if similar_names else "Desconocido"
...
def get_attack_name(attack_id, attack_data):
    ...
    return find_most_similar_attack_name(target_name, attack_names)
